...
INSERT INTO `accounts` VALUES (1,'Алиса','123!'),(2,'Боб','#457'),(3,'Ева','hohoho');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Товарные позиции';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER check_null BEFORE INSERT ON products FOR EACH ROW 
BEGIN
IF NEW.name IS NULL AND NEW.description IS NULL
THEN SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Failed ! Can not be NULL in name and description fields at the same time !';
END IF;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER check_null_update_old BEFORE UPDATE ON products FOR EACH ROW
BEGIN
IF OLD.name IS NULL AND OLD.description IS NULL
THEN SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Failed ! Can not be NULL in name and description fields at the same time !';
END IF;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER check_null_update_new BEFORE UPDATE ON products FOR EACH ROW
BEGIN
IF NEW.name IS NULL AND NEW.description IS NULL
THEN SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Failed ! Can not be NULL in name and description fields at the same time !';
END IF;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `username` AS select `a`.`id` AS `user_id`,`a`.`name` AS `user_name` from `accounts` `a` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-04-28  1:35:16
